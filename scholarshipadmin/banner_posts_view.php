...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		"`banner_posts`.`id`" => "id",
		"IF(    CHAR_LENGTH(`scholarships1`.`title`) || CHAR_LENGTH(`scholarships1`.`id`), CONCAT_WS('',   `scholarships1`.`title`, ' :id ', `scholarships1`.`id`), '') /* Title */" => "title",
	...
	$x->QueryFrom = "`banner_posts` LEFT JOIN `scholarships` as scholarships1 ON `scholarships1`.`id`=`banner_posts`.`title` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
