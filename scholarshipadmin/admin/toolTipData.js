...
// scholarship_categories table
scholarship_categories_addTip=["",spacer+"This option allows all members of the group to add records to the 'scholarship categories' table. A member who adds a record to the table becomes the 'owner' of that record."];

scholarship_categories_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'scholarship categories' table."];
scholarship_categories_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'scholarship categories' table."];
scholarship_categories_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Scholarship categories' table."];
scholarship_categories_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Scholarship categories' table."];

scholarship_categories_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Scholarship categories' table."];
scholarship_categories_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Scholarship categories' table."];
scholarship_categories_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Schlarship
categories' table."];
scholarship_categories_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Scholarship categories' table, regardless of their owner."];

scholarship_categories_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Scholarship categories' table."];
scholarship_categories_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Scholarship categories' table."];
scholarship_categories_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Scholarship categories' table."];
scholarship_categories_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Scholarship categories' table."];

// scholarships table
scholarships_addTip=["",spacer+"This option allows all members of the group to add records to the 'Scholarships' table. A member who adds a record to the table becomes the 'owner' of that record."];

scholarships_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Scholarships' table."];
scholarships_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Scholarships' table."];
scholarships_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Scholarships' table."];
scholarships_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Scholarships' table."];

scholarships_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Scholarships' table."];
scholarships_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Scholarships' table."];
scholarships_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Scholarships' table."];
scholarships_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Scholarships' table, regardless of their owner."];

scholarships_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Scholarships' table."];
scholarships_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Scholarships' table."];
scholarships_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Scholarships' table."];
scholarships_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Scholarships' table."];
