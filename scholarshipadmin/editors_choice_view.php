...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"IF(    CHAR_LENGTH(`scholarships1`.`title`) || CHAR_LENGTH(`scholarships1`.`author`), CONCAT_WS('',   `scholarships1`.`title`, ' :author ', `scholarships1`.`author`), '') /* Blog */" => "scholarship"
	);
	...
	$x->QueryFieldsFilters = array(   
		"`editors_choice`.`id`" => "ID",
		"IF(    CHAR_LENGTH(`scholarships1`.`title`) || CHAR_LENGTH(`scholarships1`.`author`), CONCAT_WS('',   `scholarships1`.`title`, ' :author ', `scholarships1`.`author`), '') /* Blog */" => "Blog"
	);
	...
	$x->filterers = array(  'scholarship' => 'Blog');

	$x->QueryFrom = "`editors_choice` LEFT JOIN `scholarships` as scholarships1 ON `scholarships1`.`id`=`editors_choice`.`scholarship` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->ColFieldName = array('scholarship');
	$x->ColNumber  = array(2);
