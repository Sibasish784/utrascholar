...
<html lang="en">
  <head>
    ...
    <title><?php echo ucwords('SCHOLARSHIP ADMIN'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
    <!-- Bootstrap core CSS -->
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="scholarships_view.php"><i class="fa fa-rss"></i>Scholarships</a></li>
            <li><a href="scholarship_categories_view.php"><i class="fa fa-tags"></i>Categories</a></li>
            <li><a href="scholarships_view.php"><i class="fa fa-check"></i>Published</a></li>
