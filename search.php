...
<body>
    ...
    $sql = 'SELECT * FROM scholarships WHERE title LIKE :keyword OR content LIKE :keyword  OR tags LIKE :keyword OR author LIKE :keyword ORDER BY id DESC ';
	...
	<section class="main-content-w3layouts-agileits">
		...
		# code...
    					...
    					?>
				<!--left-->
				<div class="left-scholarship-info-w3layouts-agileits text-left">
					<div class="row">
						<?php
    					if(!empty($result)) { 
						...
						<div class="col-lg-4 card">
							<a href="single.php?id=<?php echo $row['id']; ?>">
								<img src="scholarshipadmin/images/<?php echo $row['photo']; ?>" class="card-img-top img-fluid" alt="fantastic cms" style="width: 480px;height: 300px">
							</a>
							<div class="card-body">
