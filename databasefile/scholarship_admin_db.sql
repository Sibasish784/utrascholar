...
INSERT INTO `scholarship_categories` (`id`, `name`) VALUES
(1, 'ALL TIME OPEN'),
(2, 'CURRENT'),
(3, 'UPCOMING'),
(4, 'PASSED'),
...
CREATE TABLE `editors_choice` (
  `id` int(10) UNSIGNED NOT NULL,
  `scholarship` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `editors_choice` (`id`, `scholarship`) VALUES
(2, 3),
(1, 4);
...
(1, 2, 'titles', 1, 3, 3, 3),
(2, 2, 'links', 1, 3, 3, 3),
(3, 2, 'scholarship_categories', 1, 3, 3, 3),
(4, 2, 'scholarships', 1, 3, 3, 3),
(5, 2, 'banner_posts', 1, 3, 3, 3),
(6, 2, 'editors_choice', 1, 3, 3, 3),
(32, 3, 'titles', 0, 0, 0, 0),
(33, 3, 'links', 0, 0, 0, 0),
(34, 3, 'scholarship_categories', 0, 3, 0, 0),
(35, 3, 'scholarships', 1, 1, 1, 1),
...
(3, 'scholarship_categories', '1', 'admin', 1524773915, 1524773915, 2),
(4, 'scholarship_categories', '2', 'admin', 1524773923, 1524773923, 2),
(5, 'scholarship_categories', '3', 'admin', 1524773931, 1524773931, 2),
(6, 'scholarship_categories', '4', 'admin', 1524773941, 1524773941, 2),
(7, 'scholarship_categories', '5', 'admin', 1524773974, 1524773974, 2),
(8, 'scholarships', '1', 'admin', 1524778647, 1524791344, 2),
(9, 'banner_posts', '1', 'admin', 1524779492, 1524779492, 2),
(10, 'scholarships', '2', 'admin', 1524780270, 1524781513, 2),
(11, 'scholarships', '3', 'admin', 1524780339, 1524789616, 2),
(12, 'scholarships', '4', 'admin', 1524790853, 1524790853, 2),
(13, 'editors_choice', '1', 'admin', 1524799889, 1524799889, 2),
(14, 'editors_choice', '2', 'admin', 1524799903, 1524799903, 2),
(15, 'scholarships', '5', 'etemesi', 1524856026, 1524856026, 3),
(16, 'scholarships', '6', 'etemesi', 1524856225, 1524856225, 3),
(17, 'scholarship_categories', '6', 'etemesi', 1524858044, 1524858044, 3);
...
(1, 'ULTRA SCHOLAR', 'scholarship For Passion', '95401600_1524766758.jpg', 'scholarship,tech scholarship,tricks,hacks,technology news,fantastic scholarship', 'This is a scholarship and content management system,You can easily setup your scholarship and customize it according to your needs.This is a short description of your scholarship.You can change this', 'Create a lifestyle <span>you desire</span>', 'Engaging Purposeful <span>and Creative</span>', 'Create the lifestyle <span>you desire</span>', 'Engaging Purposeful <span>and Creative</span>', 'This is a scholarship and content management system,You can easily setup your scholarship and customize it according to your needs.It is easy to use and manage.Multiple users can signup and be able contribute content.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodtempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodoconsequat. Duis aute irure dolor in reprehenderit in voluptate velit essecillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat nonproident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'Nairobi,Kenya', 'info@fantasticscholarship.com', '0708344101', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100949.24429313939!2d-122.44206553967531!3d37.75102885910819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan+Francisco%2C+CA%2C+USA!5e0!3m2!1sen!2sin!4v1');
