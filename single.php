...
$id=$_REQUEST['id']; $query="SELECT * from scholarships where id='".$id."'"; $result=mysqli_query($GLOBALS["___mysqli_ston"],$query) or die ( ((is_object($GLOBALS["___mysqli_ston"]))? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ?$___mysqli_res : true))); 
...
<head>
	...
	<meta charset="utf-8">
	<link id="browser_favicon" rel="shortcut icon" href="scholarshipadmin/images/<?php geticon("titles"); ?>">
...
<body>
	...
	<section class="banner-bottom">
		...
		<div class="container">
			<div class="row">
				<!--left-->
				<div class="col-lg-8 left-scholarship-info-w3layouts-agileits text-left">
					<div class="scholarship-grid-top">
						<div class="b-grid-top">
							<div class="scholarship_info_left_grid">
								<a href="#">
									<img src="scholarshipadmin/images/<?php echo $row['photo']; ?>" class="img-fluid" alt="image not available" style="width:900px;height:300px">
								</a>
							</div>
							<div class="scholarship-info-middle">
								...
								<!--//left-->
								<!--right-->
								<aside class="col-lg-4 agileits-w3ls-right-scholarship-con text-right">
									<div class="right-scholarship-info text-left">
